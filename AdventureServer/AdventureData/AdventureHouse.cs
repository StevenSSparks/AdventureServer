    ...
    public class AdventureHouse
    {
        ...
        public PlayAdventure SetupAdventure(string gameid)
                ...
                var _items = new List<Item>
            {
                ...
                new Item { Name="PIE", Description= "A small slice of apple pie. Mouthwatering.",Location = 10, Action= "A little cold, but there is never really a good reason to turn down pie.", ActionVerb="EAT", ActionResult="HEALTH", ActionValue ="100", ActionPoints = 10 },
                ...
                new Item { Name="KITTEN", Description= "A delightful kitten",Location = 20, Action= "The little fuzzball, a black and white kitten just looks so adorable!", ActionVerb="PET", ActionResult="FOLLOW", ActionValue ="20", ActionPoints=50 },
                new Item { Name="SLIP", Description= "A small slip of paper that looks like The fortune cookie slip from yesterdays DEVELOPER lunch. The words seem to fade away and back over and over.",Location = 18, Action= "the fortune cookie slip from yesterdays DEVELOPER lunch", ActionVerb="READ", ActionResult="FORTUNE", ActionValue ="1", ActionPoints=33 },
#if (DEBUG)                  
