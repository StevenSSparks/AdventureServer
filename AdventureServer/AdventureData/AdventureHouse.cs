    ...
    public class AdventureHouse
    {
        ...
        public PlayAdventure SetupAdventure(string gameid)
                ...
                var _items = new List<Item>
            {
                ...
                new Item { Name="SLIP", Description= "A small slip of paper that looks like The fortune cookie slip from yesterdays DEVELOPER lunch. The words seem to fade away and back over and over.",Location = 18, Action= "The fortune cookie slip from yesterdays DEVELOPER lunch", ActionVerb="READ", ActionResult="FORTUNE", ActionValue ="1", ActionPoints=1 },
#if (DEBUG)                  
